...
Workflow Monitor 是面向 Windows 科研 Git 项目的本地工作台，用于集中查看 AI 协作中的当前目标、任务生命周期、科研探索、决策、资料、诊断和发布状态。
...
建议先阅读[快速开始](getting-started.md)，再了解[工作台](workbench.md)以及[稳定维护与科研探索](lifecycle.md)的区别。
