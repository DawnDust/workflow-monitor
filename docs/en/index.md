...
Workflow Monitor is a local Windows workbench for AI-assisted scientific Git projects. It makes the current goal, task lifecycle, research attempts, decisions, resources, diagnostics, and release state visible in one place.

![Workflow Monitor project overview](../assets/workflow-monitor-overview.png)

## Core guarantees

- The graphical workbench is read-only for project business data.
...
Start with [Getting started](getting-started.md), then learn the [workbench](workbench.md) and the distinction between [maintenance and research](lifecycle.md).
