...
MAINTENANCE_CORE += '\n9. 相关科研变化通过 review show 查看范围，随 report/end 填报 reviews；14 天仅兜底提醒，允许主动审阅，无关事项延后，不改变门禁。\n'
MAINTENANCE_RESEARCH += '\n审阅按关联变化触发，活跃内容 14 天兜底，暂停后恢复检查；使用 review list/show 与 report/end reviews，详见 AUTOMATION.md。\n'
AGENTS_BLOCK = AGENTS_BLOCK.replace("<!-- project-maintenance-hooks:end -->", '- 科研维护按相关变化触发，14 天仅兜底提醒；通过 review show 查看范围并随 report/end 填报 reviews，允许主动审阅，无关事项延后，延期不替代门禁。\n<!-- project-maintenance-hooks:end -->')
