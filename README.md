...
```powershell
pipx install https://github.com/DawnDust/project-maintenance-template/releases/download/v1.0.3/project_maintenance_workflow-1.0.3-py3-none-any.whl
```
...
确认时不会执行推送或标签操作。工作台可通过“类型”下拉框按提示词分类筛选，并与文本
筛选组合使用。
