...
- 日常入口包括工作流、概览、搜索、资料、工作台、科研阶段和证据矩阵；左下角“设置”集中提供界面语言、状态解释和高级查看。
...
- “设置”中的“解释”按类别折叠展示状态含义、实际影响和安全下一步，覆盖工作流、任务、动作、阶段、探索、决策、资料及 Git/Release；“语言”只切换界面文字并保存在本机，项目、任务、阶段、探索、资料和事件记载始终按原文展示。
